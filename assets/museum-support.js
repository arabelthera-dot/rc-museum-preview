...
(function(){
  ...
  var T = EN ? {
    ...
    peak:'Музей создаёт небольшая команда. Ты можешь <b>рассказать о странице</b>, <b>предложить источник</b>, <b>сообщить об ошибке</b> или <b>помочь профессионально</b> — со съёмкой, текстом и озвучкой.',
    share:'⤴ Поделиться страницей',
    correct:'Сообщить об ошибке',
    more:'Поддержать проект →',
    final:'<b>Поддержать проект</b> можно своим участием: рассказать о музее, предложить источник, сообщить об ошибке или помочь профессионально. <a href="MAILTO">Напиши команде</a>, чем хочешь помочь. Если хочешь <b>поддержать проект рублём</b>, сначала уточни у команды доступный способ.',
