(function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    if (game) {
      var data = [
          {
            q: "Как прочитать эту книжную подпись честно?",
            a: [
              [
                "bad",
              ...
              [
                ...
                "Одна книжная подпись не доказывает материал фасадов Вятского.",
              ],
            ],
          },
          {
            q: "Что подпись позволяет сказать о материале?",
            a: [
              ["good", "На этой избе подпись называет лепнину гипсовой", "Да. Это точная граница одного документированного дома."],
              ["bad", "Вся лепнина Ярославской области гипсовая", "Одна подпись не описывает весь региональный корпус."],
          ...
          },
          {
            ...
            a: [
              ["bad", "Речь идёт о доме Саловых", "Это уже прямо сказано в подписи и не требует отдельной региональной теории."],
              ["bad", "Снимок сделан в 1984 году", "Год уже дан в подписи."],
              ["good", "Такой декор связан с отходным лепным промыслом", "Да. Связь с промыслом опирается на текст исследования, а не выводится из одной подписи."],
            ],
          },
        ],
        i = 0,
        ...
        window.setTimeout(function () {
          ...
          if (i === data.length) {
            ...
            feedback.textContent =
              "Книжная подпись подтверждает один региональный пример, но не место во Вятском и не материал всех его фасадов.";
            actions.innerHTML = "";
            reset.hidden = false;
